...
/**
 * Front Page Template
 * Shows product cards that link to /offer/ page
 *
 * @package InterAgents
 */
...
// Pricing for "from" labels on cards
$lang     = ia_get_lang();
$is_pl    = $lang === 'pl';
...
$pricing = array(
	...
	'complete'  => $is_pl ? 15000 : round( 15000 / $rate / 100 ) * 100,
);

$offer_url = home_url( '/offer/' );
if ( ! $is_pl ) {
	$offer_url = add_query_arg( 'lang', 'en', $offer_url );
}
?>
...
<!-- Offer Cards (link to /offer/ page) -->
<section class="section section--offer" id="offer">
	<div class="container">
		...
		<div class="offer-products" id="offer-products">
			<!-- OpenClaw -->
			<a class="offer-product-card offer-product-card--link" href="<?php echo esc_url( add_query_arg( 'product', 'openclaw', $offer_url ) ); ?>">
				...
				<div class="offer-product-from">
					...
					<strong><?php echo number_format( $pricing['openclaw'], 0, '', $is_pl ? ' ' : ',' ); ?> <?php echo $currency; ?></strong>
				</div>
				<span class="offer-product-arrow"><?php echo esc_html( ia_t( 'Skonfiguruj →', 'Configure →' ) ); ?></span>
			</a>

			<!-- InterCore -->
			<a class="offer-product-card offer-product-card--link" href="<?php echo esc_url( add_query_arg( 'product', 'intercore', $offer_url ) ); ?>">
				<div class="offer-product-icon">
					<svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<div class="offer-product-from">
					<?php echo esc_html( ia_t( 'od', 'from' ) ); ?>
					<strong><?php echo number_format( $pricing['intercore'], 0, '', $is_pl ? ' ' : ',' ); ?> <?php echo $currency; ?></strong>
					<?php echo esc_html( ia_t( 'wdrożenie', 'setup' ) ); ?>
				</div>
				<span class="offer-product-arrow"><?php echo esc_html( ia_t( 'Dowiedz się więcej →', 'Learn more →' ) ); ?></span>
			</a>

			<!-- Pełna Moc / Complete -->
			<a class="offer-product-card offer-product-card--link" href="<?php echo esc_url( add_query_arg( 'product', 'complete', $offer_url ) ); ?>">
				<div class="offer-product-icon">
					<svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<div class="offer-product-from">
					<?php echo esc_html( ia_t( 'od', 'from' ) ); ?>
					<strong><?php echo number_format( $pricing['complete'], 0, '', $is_pl ? ' ' : ',' ); ?> <?php echo $currency; ?></strong>
					<?php echo esc_html( ia_t( 'wdrożenie', 'setup' ) ); ?>
				</div>
				<span class="offer-product-arrow"><?php echo esc_html( ia_t( 'Dowiedz się więcej →', 'Learn more →' ) ); ?></span>
			</a>
